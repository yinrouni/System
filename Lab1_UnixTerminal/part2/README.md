...
### Response/Observations
- In function, the instrucions utilize registers that reserved for special use. Swap uses %rdi, %rsi for the first ad second parameters. These registers are the pointers to the integers that we want to swap.
